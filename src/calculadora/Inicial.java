...
public class Inicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        calcText.setFont(new java.awt.Font("Tahoma", 0, 28)); // NOI18N
        calcText.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(calcText, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        a = Double.parseDouble(calcText.getText());
        }
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        ...
        b = Double.parseDouble(calcText.getText());
        if(op == 1){
        calcText.setText(Double.toString(calculo.dividir(a, b)));
        }
        if(op == 2){
        calcText.setText(Double.toString(calculo.multiplicar(a, b)));
        }
        if(op == 3){
        calcText.setText(Double.toString(calculo.subtrair(a, b)));
        }
        if(op == 4){
        calcText.setText(Double.toString(calculo.somar(a, b)));
        }
            }
        }
